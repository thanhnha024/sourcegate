<?php
/*
 * Template Name: Project Full Template
...
<div class="full_wrapper padtb_85_90 full_potfolio_img">
      <div class="container">
        <div class="row">
      ...
      <!-- /nimble-portfolio-->
      <div class="portfolio-section port-col full_view">
    ...
    ?>
              <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 project_img mbot30 effect-goliath isotopeSelector <?php echo esc_attr($cate_slug);?>">
