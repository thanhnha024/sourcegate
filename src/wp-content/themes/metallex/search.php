...
<?php } ?>
        <div class="thm-container">
            <h2><?php printf( esc_html__( 'Search Results for: %s', 'metallex' ), get_search_query() ); ?></h2>
        </div><!-- /.thm-container -->
    </section>
    ...
    <div class="full_wrapper padtb_100_95">
     ...
     ?>
            ...
            <div class="search-custom" ><h4><?php
                            ...
                            echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'metallex' ) ;?></h4>
