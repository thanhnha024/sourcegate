...
<?php } ?>
        <div class="thm-container">
            <h2><?php printf( esc_html__( 'Tag Archives: %s', 'metallex' ), single_tag_title( '', false ) ); ?></h2>
        </div><!-- /.thm-container -->
    </section>
    ...
    <div class="full_wrapper padtb_100_95">
     ...
     ?>
                ...
                <p class="mbot25 gray_color1 clear-none"><?php if(isset($metallex_redux_demo['blog_excerpt'])){?>
                                ...
                                ?></p>
                <?php the_tags(); ?>
                                <a href="<?php the_permalink();?>" class="view-all hvr-bounce-to-right news_read_btn"><?php if(isset($metallex_redux_demo['read_more'])){?>
